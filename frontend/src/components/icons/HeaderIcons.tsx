...
export const CryptoSwapIcon = React.memo(function CryptoSwapIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
...
export const TelegramIcon = React.memo(function TelegramIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
export const WagerRacesIcon = React.memo(function WagerRacesIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
