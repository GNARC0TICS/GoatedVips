        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <Tabs defaultValue="stats" className="w-full" onValueChange={setActiveTab}>
              ...
              >
                <LazyLoad
                  importer={() => import("@/components/RankProgressDisplay")}
                  placeholder={<LoadingSpinner />}
                  componentProps={{ wagerAmount: user.totalWagered || 0 }}
                />
              </TabsContent>
              ...
              >
                <LazyLoad
                  importer={() => import("@/components/SessionHistory")}
                  placeholder={<LoadingSpinner />}
              ...
              >
                <LazyLoad
                  importer={() => import("@/components/WagerRacePosition")}
                  placeholder={<LoadingSpinner />}
                  componentProps={{ userId: user.id, goatedUsername: user.goatedUsername }}
                />
              </TabsContent>
            </Tabs>
          </motion.div>
