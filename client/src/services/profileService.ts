...
export const UserProfileSchema = z.object({
  ...
  goatedUsername: z.string().optional().nullable(),
  email: z.string().optional().nullable(),
  createdAt: z.string().optional().nullable(),
  lastActive: z.string().optional().nullable(),
  goatedAccountLinked: z.boolean().optional().nullable(),
...
class ProfileService {
  ...
  async getProfile(userId: string | number): Promise<UserProfile> {
    ...
    try {
      ...
      const fallbackResponse = await fetch(`${this.baseUrl}/users/ensure-profile`, {
        method: 'POST',
        headers: {
