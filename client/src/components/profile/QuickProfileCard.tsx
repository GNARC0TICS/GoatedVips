...
import { colors, cardStyles, textStyles, buttonStyles, gradients } from '@/lib/style-constants';
import { fadeIn, fadeInUp, scaleIn, badgeBounce, cardListItem } from '@/lib/animation-presets';
...
export function QuickProfileCard({
  ...
  return (
    <motion.div {...fadeIn}>
      <Card className={cn(cardStyles.base, 'overflow-hidden shadow-xl border', 
        size === 'sm' ? 'w-64' : 
        size === 'lg' ? 'w-96' : 
        'w-80', 
        className
