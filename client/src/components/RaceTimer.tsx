          ...
          >
            ...
            >
              {!isLoading && currentRaceData && !hasSeenNotification && !isContentVisible && (
                <span className="absolute -top-0.5 -left-1.5 w-3 h-3 bg-red-500 rounded-full shadow-[0_0_8px_rgba(239,68,68,0.6)] animate-[pulse_2s_cubic-bezier(0.4,0,0.6,1)_infinite] ring-2 ring-red-400/50" />
              )}
              {isLoading ? (
