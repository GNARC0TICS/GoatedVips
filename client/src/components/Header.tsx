...
import { MobileNavigation, DesktopNavLinks } from "./NavigationLinks";
    ...
    <header className={headerClasses.container}>
      <nav className={headerClasses.nav}>
        <div
          ...
          className={`md:hidden fixed left-0 right-0 top-16 bg-[#14151A] border-b border-[#2A2B31] transition-all duration-300 z-50 ${mobileSearchOpen ? 'h-16 opacity-100' : 'h-0 opacity-0 pointer-events-none'}`}
          style={{
        ...
        <div className="flex items-center gap-2">
          <div className={headerClasses.menuButton}>
            <Sheet open={openMobile} onOpenChange={setOpenMobile}>
              ...
              >
                <MobileNavigation setOpenMobile={setOpenMobile} isAuthenticated={isAuthenticated} />
