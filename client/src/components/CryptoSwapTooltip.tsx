    ...
    <div className="fixed bottom-6 left-6 z-40 max-w-sm">
      <div className="relative bg-[#1A1C23]/60 backdrop-blur-md border border-[#D7FF00]/30 p-4 rounded-xl shadow-lg shadow-[#D7FF00]/10">
        <Button
          ...
          className="absolute top-2 right-2 text-gray-400 hover:text-white transition-colors bg-transparent p-1 h-auto w-auto min-h-0 min-w-0 hover:bg-gray-800/50"
          size="icon"
          variant="ghost"
          aria-label="Close"
          type="button"
