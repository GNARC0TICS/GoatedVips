            ...
            >
              ...
              >
                <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                    ...
                    <h3 className="text-2xl font-heading uppercase mb-4 text-white text-center">
                      Bonus Codes
                      {!isAuthenticated && <Lock className="h-4 w-4 text-[#8A8B91]" />}
                    </h3>
                    <p className="text-[#8A8B91] text-center mb-6">
                      {isAuthenticated 
                    ...
                    <div className="flex items-center text-[#D7FF00] mt-auto">
                      <Link to="/bonus-codes" className="group flex items-center">
                        <span className="mr-2">Explore Bonus Codes</span>
                ...
                <Link href="/vip-transfer" className="block">
                  <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                      ...
                      <div className="flex items-center text-[#D7FF00] mt-auto">
                        <Link to="/vip-transfer" className="group flex items-center">
                          <span className="mr-2">Apply for Transfer</span>
                          <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
                      </div>
                    </div>
                ...
                <Link href="/wager-races" className="block">
                  <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                      ...
                      <div className="flex items-center text-[#D7FF00] mt-auto">
                        <Link to="/wager-races" className="group flex items-center">
                ...
                <Link href="/challenges" className="block">
                  <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                      ...
                      <div className="flex items-center text-[#D7FF00] mt-auto">
                        <Link to="/challenges" className="group flex items-center">
                ...
                <Link href="/wheel-challenge" className="block">
                  <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                      <div className="flex justify-start mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" className="text-[#D7FF00]">
                      ...
                      <div className="flex items-center text-[#D7FF00] mt-auto">
                        <Link to={isAuthenticated ? "/wheel-challenge" : "/login"} className="group flex items-center">
                          <span className="mr-2">{isAuthenticated ? "Try Your Luck" : "Sign In to Play"}</span>
                          <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
                      </div>
                    </div>
              ...
              >
                <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                    <div className="flex justify-start mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" className="text-[#D7FF00]">
                    ...
                    <div className="flex items-center text-[#D7FF00] mt-auto">
                      <Link to="/provably-fair" className="group flex items-center">
                ...
                <Link href="/goated-token" className="block">
                  <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                      ...
                      <div className="flex items-center text-[#D7FF00] mt-auto">
                        <Link to="/goated-token" className="group flex items-center">
                          <span className="mr-2">Learn About Airdrops</span>
                          <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
                      </div>
                    </div>
                ...
                <Link href="/promotions" className="block">
                  <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                      ...
                      <div className="flex items-center text-[#D7FF00] mt-auto">
                        <Link to="/promotions" className="group flex items-center">
                          <span className="mr-2">View Promotions</span>
                          <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
                      </div>
                    </div>
                ...
                <Link href="/telegram" className="block">
                  <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="relative p-6 md:p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-all duration-300 shadow-lg hover:shadow-[#FFD700]/20 card-hover h-full w-full flex flex-col justify-between">
                      ...
                      <div className="flex items-center text-[#D7FF00] mt-auto">
                        <Link to="/telegram" className="group flex items-center">
